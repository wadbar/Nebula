  ...
  return (
    <aside className="w-20 md:w-24 fixed left-0 top-0 bottom-0 bg-[var(--md-sys-color-surface-container)] border-r border-[var(--md-sys-color-outline-variant)] flex flex-col py-8 z-50 transition-all group/sidebar hover:w-64">
      <div className="px-6 mb-12 flex flex-col items-center group-hover/sidebar:items-start transition-all">
        <div className="w-10 h-10 bg-brand-green/10 border border-brand-green/30 rounded-2xl flex items-center justify-center group-hover/sidebar:w-12 group-hover/sidebar:h-12 transition-all">
          <div className="w-5 h-5 bg-brand-green rounded-full animate-pulse shadow-[0_0_15px_#00FF41]" />
        </div>
        <div className="hidden group-hover/sidebar:block mt-4 animate-in fade-in slide-in-from-left-4">
           <h1 className="text-xs font-black text-white tracking-[0.4em] uppercase">Nebula OS</h1>
           <p className="text-[8px] font-mono text-brand-green/60 uppercase mt-1">Core Kernel Active</p>
        </div>
      </div>
